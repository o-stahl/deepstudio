...
export const HANDLEBARS_TEMPLATE_PROJECT: ProjectTemplate = {
  name: 'Handlebars Components Demo',
  description: 'Showcase of Handlebars templating with reusable components and dynamic content',
  directories: ['/templates', '/styles'],
  files: [
    {
      path: '/templates/layout.hbs',
      content: `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body>
  ...
  <div class="card-content">
    ...
    {
      path: '/templates/product-list.hbs',
  ...
  {{/each}}
    ...
    {
      path: '/index.html',
      content: `{{> layout pageTitle="Home - Component Demo"}}

<div class="hero">
  <h2>Welcome to {{siteName}}</h2>
  <p>This demonstrates Handlebars templating with reusable components.</p>
</div>
...
<section class="info">
  <div class="info-grid">
    ...
    {
      path: '/about.html',
      content: `{{> layout pageTitle="About - Component Demo"}}
...
<div class="content">
  <p>This project showcases the power of Handlebars templating in DeepStudio.</p>
  ...
  {{/if}}
    ...
    },
    {
      path: '/data.json',
      content: `{
  "siteName": "ComponentLab",
  "pageTitle": "Home",
  "currentYear": 2024,
  "navigation": [
    {"title": "Home", "url": "/", "active": true},
    {"title": "About", "url": "/about.html", "active": false},
    {"title": "Products", "url": "/products.html", "active": false}
  ],
  "social": [
  ...
  "products": [
    ...
    {
      "name": "Standard Tool",
      "description": "An everyday tool for common tasks",
      "price": 49,
      "image": "https://via.placeholder.com/300x200",
      "featured": false,
      "categories": ["tools", "everyday"]
    },
    {
      "name": "Deluxe Package",
      ...
      "image": "https://via.placeholder.com/300x200",
      "featured": true,
      "categories": ["premium", "bundle"]
    }
  ],
  "features": [
    {
      "title": "Reusable Components",
      "description": "Create once, use everywhere with Handlebars partials",
      "highlight": true
    },
    {
      "title": "Dynamic Content",
      "description": "Data-driven templates with JSON context files",
      "highlight": false
    },
    {
      "title": "Helper Functions",
      "description": "Built-in helpers for logic, math, and formatting",
      "highlight": false
    }
  ],
  "templateFeatures": [
    ...
    "Built-in helpers (eq, gt, if, each, etc.)",
...
// Enhanced function for demo project that includes background image
